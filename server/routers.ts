  ...
  projects: router({
    ...
    create: protectedProcedure
      .input(z.object({
        ...
        scopeType: z.enum(["pergola", "canopy", "enclosure", "fencing", "lumon", "tsawwassen"]).default("pergola"),
      }))
  ...
  renderings: router({
    ...
    generate: protectedProcedure
      .input(z.object({
        ...
        scopeType: z.enum(["pergola", "canopy", "enclosure", "fencing", "lumon", "tsawwassen"]).optional(),
