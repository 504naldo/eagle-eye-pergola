...
The overhead shade system consists of a fixed aluminum slat roof, powder coated in Matte Black, with integrated LED string lighting. The patio is fully enclosed on three sides by a Lumon vertical glazing system — front face, left side, and right side — with the glass top rail integrated directly to the front fascia beam for a weathertight, seamless connection.
...
console.log("✓ Project parameters seeded (58' × 15'-8\", 5 front posts, fixed slats, Lumon glass 3 sides)");
...
const checklistItems = [
  ...
  // Lumon Enclosure
  { cat: "Lumon Enclosure", label: "Confirm Lumon panel layout — front, left side, and right side", order: 21 },
  { cat: "Lumon Enclosure", label: "Confirm glass top rail connection to fascia beam — coordinate with Lumon supplier", order: 22 },
  { cat: "Lumon Enclosure", label: "Confirm door / opening locations in Lumon front panel", order: 23 },
  { cat: "Lumon Enclosure", label: "Confirm glass corner condition detail at front/side intersections", order: 24 },
];
...
const scopeItems = [
  ...
  { type: "inclusion", text: "Lumon vertical enclosure — front face, left side, and right side (3 sides total)", order: 6 },
  { type: "inclusion", text: "Lumon top rail integrated connection to front fascia beam — weathertight sealant joint", order: 7 },
  ...
  { type: "exclusion", text: "Lumon supply and installation — separate contract with Lumon supplier", order: 8 },
  ...
  { type: "assumption", text: "Lumon glass system is supplied and installed by Lumon under a separate contract — this scope covers the aluminum pergola frame only", order: 4 },
  ...
  { type: "by_others", text: "Lumon glass supplier — supply and install vertical Lumon panels on all three sides", order: 3 },
